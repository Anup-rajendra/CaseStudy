...
namespace AdminAccess.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,CategoryId,SupplierId,InventoryId,Name,Price,PhotoUrl,Description")] Product product)
        {
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            ProductNotification productNotification=_context.ProductNotifications.FirstOrDefault(p=>p.Productid== id);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            var productNotifications = _context.ProductNotifications
                                        .Where(pn => pn.Productid == id)
                                        .ToList();


            foreach(ProductNotification pn in productNotifications )
            {
                _context.ProductNotifications.Remove(pn);
                await _context.SaveChangesAsync();
            }
