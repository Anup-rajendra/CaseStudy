...
namespace AdminAccess.Controllers
{
    public class Products1Controller : Controller
    {
        ...
        public Products1Controller(RetailApplicationContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,CategoryId,SupplierId,InventoryId,Name,Price,PhotoUrl,Description")] Product product)
        {
