...
namespace AdminAccessService.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,CategoryId,SupplierId,InventoryId,Name,Price")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,CategoryName,SupplierId,InventoryId,Name,Price")] Product product)
        {
            ...
            // Find the CategoryId based on the CategoryName
            ...
            {
                product.CategoryId = category.CategoryId; // Assign the correct CategoryId
            }
            ...
            ViewData["InventoryId"] = new SelectList(_context.Inventories, "InventoryId", "Name", product.InventoryId);
