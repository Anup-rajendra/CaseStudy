...
public class Mutation
{
        ...
        public async Task<Order> AddNewOrder([Service] IRetailApplication<Order> orderItemRepository,int  userId,int totalprice,int addressId)
        {
            return await orderItemRepository.AddNewOrder(userId, totalprice,addressId);   
        }
