...
import { GET_PRODUCTS, GET_CART_TABLE, CREATE_OR_UPDATE_CART, UPDATE_CART_ITEM, GET_PRODUCTS_BY_CATEGORY } from '../Apollo/queries'; // Adjust the import path if necessary
