    ...
    useEffect(() => {
        const fetchReviews = async () => {
            ...
            try {
                ...
                const response = await axios.get(`http://localhost:5064/api/Reviews/${product.productId}`);
        ...
        <div className="product-details-container">
            ...
            <div className="product-info-section">
                ...
                {isLoading ? (
                    ...
                    <>
                        <div className="overall-rating">
                            ...
                            <p className="average-rating">{averageRating.toFixed(1)} out of 5</p>
                        </div>
                ...
                <div className="add-review-container">
                    <AddReview productId={product.productId} userId={userId} />
                </div>
            </div>
        </div>
    );
